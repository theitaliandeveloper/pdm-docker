...
chown www-data:www-data /etc/proxmox-datacenter-manager
chown -R root:www-data /etc/proxmox-datacenter-manager/auth /etc/proxmox-datacenter-manager/access /etc/proxmox-datacenter-manager/subscriptions
